...
class Ball_Node:
    ...
    def stacking_from_ball_node(self,Point):
        ...
        while current_node.position != AC.Position.Leaf:
            ...
            '''
            if AF.projection(Point,direction) < current_node.pivot_project:
                current_node = current_node.LeftChild
            else:
                current_node = current_node.RightChild
            '''
            if AF.distance_max(Point,self.left_pivot[1]) < AF.distance_max(Point,self.right_pivot[1]):
                current_node = current_node.LeftChild
            else:
                current_node = current_node.RightChild
    ...
    def search_k_nearst_from_ball_node(self,Point,k):
        ...
        while Stack != []:
            ...
            if current_node.position == AC.Position.Leaf:
                ...
                dis = AF.distance_sq_Ball(Point,current_node.centrum,current_node.radius)
